...
module precision
  ...
  !  integer,public,parameter :: dp=selected_real_kind(15,307) !! giving error on my 64bit machine
    integer,public,parameter :: dp=selected_real_kind(13,300) !! chatgpt suggestion
  !> This is integer (4B)
