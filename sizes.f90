...
module sizes
  ...
  !for test problem
  !integer,dimension(Ndim),parameter,public :: mesh=(/ 32, 32, 32 /)
  ...
  !for testing LW
  integer,dimension(Ndim),parameter,public :: mesh=(/ 125, 125, 125 /)
...
!!$  integer,dimension(Ndim),parameter,public :: mesh=(/ 256, 256, 256 /)
!!$  integer,dimension(Ndim),parameter,public :: mesh=(/ 64, 64, 64 /)
